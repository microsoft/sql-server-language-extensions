...
namespace ExtensionApiTest
{
    ...
    //
    // Description:
    //  Tests that installing an invalid/corrupt zip file returns SQL_ERROR.
    //
    ...
    //
    // Description:
    //  Tests that installing a raw DLL file (not a zip) does not crash.
    //  The file is not a valid zip, so it should return SQL_ERROR.
    //
