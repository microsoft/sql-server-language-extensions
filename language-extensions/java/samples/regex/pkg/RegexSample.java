...
public class RegexSample extends AbstractSqlServerExtensionExecutor {
    ...
    /*
    This is the main method. You can use this for local testing.
    It is not being used by the SQL Server Java language extension
    */
    ...
    public PrimitiveDataset execute(PrimitiveDataset input, LinkedHashMap<String, Object> params) {
        ...
        //Get the parameter containing the regex
        ...
        // Evaluate each row to see if regular expression is fulfilled.
        //If true, add the row to the output data (send back to SQL Server)
    ...
    //Method that evaluates regular expression
