...
const unordered_map<SQLSMALLINT, jint> x_odbcCToJavaSqlTypeMap =
{
	...
	{static_cast<SQLSMALLINT>(SQL_C_GUID), x_javaSqlNVarChar},
...
const unordered_map<jint, SQLSMALLINT> x_javaSqlTypeToOdbcCMap =
{
	...
	{x_javaSqlVarChar, static_cast<SQLSMALLINT>(SQL_C_WCHAR)},
	{x_javaSqlChar, static_cast<SQLSMALLINT>(SQL_C_WCHAR)},
