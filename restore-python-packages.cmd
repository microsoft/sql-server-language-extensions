SET ENL_ROOT=%~dp0
SET SUBMODULE_ROOT=%ENL_ROOT%\sql-server-language-extensions
CALL %SUBMODULE_ROOT%\restore-packages.cmd
nuget restore %ENL_ROOT%\packages.python.config -PackagesDirectory %SUBMODULE_ROOT%\packages
